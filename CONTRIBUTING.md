...
6. **Update Documentation & Changelog**: If you change or add a command, or modify existing logic, please update the relevant files in the `docs/` folder and add an entry to `CHANGELOG.md`. This requirement applies to all changes, including those assisted or generated by AI.
