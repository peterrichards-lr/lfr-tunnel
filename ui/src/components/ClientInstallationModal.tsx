...
export default function ClientInstallationModal({
  ...
  // Body-scroll locking, Escape and focus restoration all live in ModalShell now, so this
  // effect keeps only the part that is specific to this dialog: guessing which platform tab
  // to open on.
  useEffect(() => {
    if (!isOpen) return;
  ...
  return (
    <ModalShell
      ...
      cardClassName="modal-card modal-card--md flex flex-col"
    >
